...
namespace Cecs475.BoardGames.Chess.Model {
	...
	public class ChessMove : IGameMove, IEquatable<ChessMove> {
		...
		public ChessPieceType ChessPiece {get; set;}
		...
		public virtual bool Equals(ChessMove other) {
			...
			if (other.MoveType == ChessMoveType.PawnPromote && other.ChessPiece == ChessPieceType.Queen) {
				return this.StartPosition == other.StartPosition && this.EndPosition == (other.EndPosition) && this.ChessPiece ==
					other.ChessPiece && this.MoveType == other.MoveType;
			}
			else if (other.MoveType == ChessMoveType.PawnPromote && other.ChessPiece == ChessPieceType.Knight) {
				return this.StartPosition == other.StartPosition && this.EndPosition == (other.EndPosition) && this.ChessPiece ==
					other.ChessPiece && this.MoveType == (other.MoveType);
			}
			else if (other.MoveType == ChessMoveType.PawnPromote && other.ChessPiece == ChessPieceType.Bishop) {
				return this.StartPosition == other.StartPosition && this.EndPosition == (other.EndPosition) && this.ChessPiece ==
					other.ChessPiece && this.MoveType == (other.MoveType);
			}
			else if (other.MoveType == ChessMoveType.PawnPromote && other.ChessPiece == ChessPieceType.Rook) {
				return this.StartPosition == other.StartPosition && this.EndPosition == (other.EndPosition) && this.ChessPiece ==
					other.ChessPiece && this.MoveType == (other.MoveType);
			} 
